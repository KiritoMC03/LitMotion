...
namespace LitMotion
{
    ...
    {
        [BurstCompile]
        public static float Evaluate(float t, LEase ease)
        {
            return ease switch
            {
                LEase.InSine => InSine(t),
                LEase.OutSine => OutSine(t),
                LEase.InOutSine => InOutSine(t),
                LEase.InQuad => InQuad(t),
                LEase.OutQuad => OutQuad(t),
                LEase.InOutQuad => InOutQuad(t),
                LEase.InCubic => InCubic(t),
                LEase.OutCubic => OutCubic(t),
                LEase.InOutCubic => InOutCubic(t),
                LEase.InQuart => InQuart(t),
                LEase.OutQuart => OutQuart(t),
                LEase.InOutQuart => InOutQuart(t),
                LEase.InQuint => InQuint(t),
                LEase.OutQuint => OutQuint(t),
                LEase.InOutQuint => InOutQuint(t),
                LEase.InExpo => InExpo(t),
                LEase.OutExpo => OutExpo(t),
                LEase.InOutExpo => InOutExpo(t),
                LEase.InCirc => InCirc(t),
                LEase.OutCirc => OutCirc(t),
                LEase.InOutCirc => InOutCirc(t),
                LEase.InElastic => InElastic(t),
                LEase.OutElastic => OutElastic(t),
                LEase.InOutElastic => InOutElastic(t),
                LEase.InBack => InBack(t),
                LEase.OutBack => OutBack(t),
                LEase.InOutBack => InOutBack(t),
                LEase.InBounce => InBounce(t),
                LEase.OutBounce => OutBounce(t),
                LEase.InOutBounce => InOutBounce(t),
                _ => t,
            };
        }
